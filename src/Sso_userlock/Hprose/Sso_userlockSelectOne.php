...
class Sso_userlockSelectOne
{
  ...
  /**
     ...
     * @return $this
     */
    public function setServerhost(string $serverhost): Sso_userlockSelectOne    {
    ...
    public function __invoke()
    {
        ...
        return call_user_func_array( [$client,'Sso_userlockSelectOne'], [$this->getSsoUserlockModel()->__toArray()]);
    }
