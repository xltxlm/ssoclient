...
class Sso_userlockInsert
{
  ...
  /**
     ...
     * @return $this
     */
    public function setServerhost(string $serverhost): Sso_userlockInsert    {
    ...
    public function __invoke()
    {
        ...
        return call_user_func_array( [$client,'Sso_userlockInsert'], [$this->getSsoUserlockModel()->__toArray()]);
    }
