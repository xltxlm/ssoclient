...
* Hprose 客户端实现
*/
class SsoctrolleruserSelectOne
{
    /** @var string 服务器的地址 */
  ...
  /**
     ...
     * @return $this
     */
    public function setServerhost(string $serverhost): SsoctrolleruserSelectOne    {
    ...
    public function __invoke()
    {
        ...
        return call_user_func_array( [$client,'SsoctrolleruserSelectOne'], [$this->getSsoctrolleruserModel()->__toArray()]);
    }
