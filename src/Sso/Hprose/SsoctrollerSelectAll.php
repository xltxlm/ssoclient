...
class SsoctrollerSelectAll
{
  ...
  /**
     ...
     * @return $this
     */
    public function setServerhost(string $serverhost): SsoctrollerSelectAll    {
    ...
    public function __invoke()
    {
        ...
        return call_user_func_array( [$client,'SsoctrollerSelectAll'], [$this->getSsoctrollerModel()->__toArray()]);
    }
