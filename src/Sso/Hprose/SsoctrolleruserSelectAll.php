...
class SsoctrolleruserSelectAll
{
  ...
  /**
     ...
     * @return $this
     */
    public function setServerhost(string $serverhost): SsoctrolleruserSelectAll    {
    ...
    public function __invoke()
    {
        ...
        return call_user_func_array( [$client,'SsoctrolleruserSelectAll'], [$this->getSsoctrolleruserModel()->__toArray()]);
    }
