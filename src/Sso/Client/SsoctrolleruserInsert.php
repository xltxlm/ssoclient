...
class SsoctrolleruserInsert
{
    ...
    */
    public function setThriftConfig(ThriftConfig $ThriftConfig )
    {
        ...
        if ($ThriftConfig->getType() == ThriftConfig::HTTP) {
            $socket = new THttpClient($ThriftConfig->getHost(), $ThriftConfig->getPort(), '?c=ThriftServer/ThriftServerSsoctrolleruserInsert');
        } else {
    ...
    */
    public function __invoke()  {
                return call_user_func_array( [$this->client,'SsoctrolleruserInsert'], [$this->getSsoctrolleruserModel()]);
    }
